...
GO
PRINT N'Rename refactoring operation with key 8c88959b-7619-485e-a6cd-782bf65121b2 is skipped, element [dbo].[ImageSaver].[Id] (SqlSimpleColumn) will not be renamed to imgId';


GO
PRINT N'Creating [dbo].[ImageSaver]...';
...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '8c88959b-7619-485e-a6cd-782bf65121b2')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('8c88959b-7619-485e-a6cd-782bf65121b2')
